...
CREATE TABLE IF NOT EXISTS `CAR` (
  ...
  `IDLICENSE` INT(30) UNSIGNED DEFAULT 0,
  `IDESSENTIAL` INT(30) UNSIGNED DEFAULT 0,
  `IDINITIAL` INT(30) UNSIGNED DEFAULT 0,
  `IDCONSOMMATION` INT(30) UNSIGNED DEFAULT 0,
  `IDUSER` INT(30) UNSIGNED DEFAULT 0,
  PRIMARY KEY (`ID`)
);
