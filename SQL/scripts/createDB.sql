...
CREATE TABLE IF NOT EXISTS `USER` (
  ...
  `INITIAL-PRICE` INT(30) UNSIGNED NOT NULL,
  `ESSENTIAL-MAINTAIN` INT(30) UNSIGNED NOT NULL,
  `CONSOMMATION` INT(30) UNSIGNED NOT NULL,
  `LICENSE-PLATE` INT(30) UNSIGNED NOT NULL,
  PRIMARY KEY (`ID`),
